...
function getHWModel(device){
    device.getDeviceModel('urn:com:oracle:iot:device:Temperature_Humidity', function (response) {
...
if (dcd.isActivated()) {
    ...
    dcd.activate(['urn:com:oracle:iot:device:Temperature_Humidity'], function (device) {
        dcd = device;
