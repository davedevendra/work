...
public class GatewayDevice extends DirectlyConnectedDevice {
    ...
    public GatewayDevice() throws GeneralSecurityException {
        super(new com.oracle.iot.client.device.GatewayDevice(), null);
    }
    ...
    public GatewayDevice(Object context) throws GeneralSecurityException {
        super(new com.oracle.iot.client.device.GatewayDevice(context), context);
    }
     ...
     *                                  loaded.
     */
    public GatewayDevice(String configFilePath, String configFilePassword, Object context)
            throws GeneralSecurityException {
        super(new com.oracle.iot.client.device.GatewayDevice(configFilePath,
                configFilePassword, context), context);
    }

    /**
     * This constructor is used internally and is not intended for general use.
     *
     * @param deviceImpl an implementation of GatewayDevice
     */
    GatewayDevice(com.oracle.iot.client.device.GatewayDevice deviceImpl) {
    ...
    */
    public String registerDevice(String hardwareId, Map<String,String> metaData, String... deviceModels)
        ...
        return ((com.oracle.iot.client.device.GatewayDevice)dcdImpl)
                .registerDevice(hardwareId, metaData, deviceModels);
    }
    ...
    public String registerDevice(boolean restricted, String hardwareId, Map<String,String> metaData, String... deviceModels)
        ...
        return ((com.oracle.iot.client.device.GatewayDevice)dcdImpl)
                .registerDevice(restricted, hardwareId, metaData, deviceModels);
